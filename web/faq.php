		...
		<div class="row justify-content-center">
			<div class="col-lg-18 col-xl-12">
				<div class="faq-item-wrap">
					<div class="faq-item">
						<h3 class="faq-item-title">What is NKshop</h3>
					...
					<div class="faq-item">
						...
						<div class="faq-item-content">
							...
							<p>Please get in touch with <a href="mailto:NKshop@gmail.com"><strong>NKshop@gmail.com</strong></a> or call us on <a href="tel:+388005553535"><strong>+3 8 800 555 35 35</strong></a></p>
						</div>
					</div>
				</div>
			</div>
