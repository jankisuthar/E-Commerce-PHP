...
input[type="checkbox"]{
  ...
  var repeatpwd = document.forms["myform"]["repeatpwd"].value;
			...
			<div class="col-md-18 col-lg-12">
				...
				<div class="form-wrapper">
					...
					<form method="post" name="myform" onsubmit="return validate();">
						...
						<div class="form-group">
							<input type="password" name="newpwd" class="form-control" placeholder="Enter new password" value="">
						</div>

						<div class="form-group">
							<input type="password" name="repeatpwd" class="form-control" placeholder="Repeat password" value="">
						</div>
											
						
						
						<div class="text-center">
							<input type="submit" class="btn" name="reset" value="Reset Password"><span style="font-weight: bold;">
						</div>
