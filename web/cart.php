...
<div class="page-content">
	...
	<div class="cart-table-prd">
		...
		<div class="cart-table-prd-action">
			<a href="cart?del_cart_id=<?php echo $c->prod_id;?>" class="cart-table-prd-remove" data-tooltip="Remove Product"><i class="icon-recycle"></i></a>
		</div>
		</form>
	</div>
...
?>
	...
	<a href="checkout" class="btn btn--full btn--lg"><span>Checkout</span></a>
