	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-18 col-lg-12">
				<h2 class="text-center">Are you a Returning Customer..? </h2>
				<div class="form-wrapper">
					...
					<form action="#">
						...
						<div class="text-center">
							<button class="btn">Sign In</button> <span style="font-weight: bold;">OR</span>  <span  class="btn"><a href="account-create.php" style="text-decoration: none;color: white;" >Create Account now</span></a>
						</div>
