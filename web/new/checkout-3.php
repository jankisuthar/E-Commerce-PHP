...
<div class="page-content">
	...
	<div class="cart-table-prd">
		<div class="cart-table-prd-image">
			<a href="#" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/products/product-01-1.webp" alt=""></a>
		</div>
		<div class="cart-table-prd-content-wrap">
			...
			<div class="cart-table-prd-price-total">
				<span style="font-weight: bold;">INR</span>352.00
			</div>
		</div>
	</div>
	<div class="cart-table-prd">
		<div class="cart-table-prd-image">
			<a href="#" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/products/product-16-1.webp" alt=""></a>
		</div>
		<div class="cart-table-prd-content-wrap">
			<div class="cart-table-prd-info">
			...
			<div class="cart-table-prd-price-total">
				<span style="font-weight: bold;">INR</span>142.00
			</div>
		</div>
	</div>
</div>
...
<div class="form-inline mt-2">
	...
	<button type="submit" class="btn">Apply</button>
				...
				<div class="cart-total-sm">
					<span>Subtotal</span>
					<span class="card-total-price"><span style="font-weight: bold;">INR</span> 494.00</span>
				</div>
				<div class="mt-2"></div>
				<div class="card">
					<div class="card-body">
