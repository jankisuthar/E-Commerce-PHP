...
<div class="holder fullwidth full-nopad mt-0">
		...
		<div class="bnslider-wrapper">
			<div class="bnslider bnslider--lg keep-scale" id="bnslider-003" data-slick='{"arrows": true, "dots": true}' data-autoplay="true" data-speed="5000"
				...
				<div class="bnslider-slide">
					<div class="bnslider-image-mobile lazyload fade-up-fast" data-bgset="images/slider/slide-03-1-m.webp"></div>
					<div class="bnslider-image lazyload fade-up-fast" data-bgset="images/slider/slide-03-1.webp"></div>
						...
						<div class="bnslider-text-content txt-middle txt-right txt-center-m">
							<div class="bnslider-text-content-flex container">
								<div class="bnslider-vert w-s-50 w-ms-80">
									...
									<div class="btn-wrap text-center mt-lg"><a href="#" class="btn btn--xl" data-animation="fadeIn" data-animation-delay="1600" tabindex="0" style="opacity: 1;">SHOP NOW</a></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="bnslider-slide">
					<div class="bnslider-image-mobile lazyload fade-up-fast" data-bgset="images/slider/slide-03-2-m.webp"></div>
					<div class="bnslider-image lazyload fade-up" data-bgset="images/slider/slide-03-2.webp"></div>
					<div class="bnslider-text-wrap bnslider-overlay">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php" class="prd-img image-hover-scale image-container">
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/products/product-01.webp" alt="Legging Red/Black" class="js-prd-img lazyload">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Legging Red/Black", "path":"images/products/product-01.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php" class="prd-img image-hover-scale image-container">
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/products/product-02.webp" alt="Leggings Snake print" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Leggings Snake print", "path":"images/products/product-02.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php" class="prd-img image-hover-scale image-container">
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/products/product-18.webp" alt="Jumpsuit with a hood" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Jumpsuit with a hood", "path":"images/products/product-18.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php" class="prd-img image-hover-scale image-container">
				<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/products/product-19.webp" alt="T-shirt Dark Blue" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "T-shirt Dark Blue", "path":"images/products/product-19.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Blue/Black", "path":"images/products/product-08.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Black/Yellow", "path":"images/products/product-07.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Camouflage", "path":"images/products/product-06.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Khaki/Black", "path":"images/products/product-05.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "T-shirt Black", "path":"images/products/product-09.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Sport Shirt Black", "path":"images/products/product-10.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "T-shirt White", "path":"images/products/product-11.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
		...
		<div class="prd-info">
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Full Zipper Hoodies", "path":"images/products/product-12.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-06.webp" alt="Brand">
	</a>
</li>
<li>
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-05.webp" alt="Brand">
	</a>
</li>
<li>
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-01.webp" alt="Brand">
	</a>
</li>
<li>
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-02.webp" alt="Brand">
	</a>
</li>
<li class="visuallyhidden js-hidden">
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-03.webp" alt="Brand">
	</a>
</li>
<li class="visuallyhidden js-hidden">
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/brands/brand-fashion-04.webp" alt="Brand">
	</a>
</li>
<li>
	<a href="#" target="_self" class="d-block image-container" title="Brand" style="padding-bottom: 37.5%;">
		...
		<div class="row bnr-grid vert-margin justify-content-md-center">
			<div class="col-sm">
				<a href="#" class="bnr image-hover-scale bnr--bottom bnr-left" data-fontratio="5.695">
					<div class="bnr-img image-container" style="padding-bottom: 121.3%"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/banners/banner-index-02.webp" class="lazyload fade-up" alt=""></div>
			...
			<div class="col-sm">
				<a href="#" class="bnr image-hover-scale bnr--middle bnr--center" data-fontratio="5.695">
					<div class="bnr-img image-container" style="padding-bottom: 121.3%">
						<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/banners/banner-index-03.webp" class="lazyload fade-up" alt="">
			...
			<div class="col-sm">
				<a href="#" class="bnr image-hover-scale bnr--bottom bnr--left" data-fontratio="5.695">
					<div class="bnr-img image-container" style="padding-bottom: 121.3%">
						<img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/banners/banner-index-04.webp" class="lazyload fade-up" alt="">
					</div>
					<div class="bnr-caption">
						<div class="bnr-text2">This week<br><span>50%</span></div>
