...
<div class="page-content">
	<div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload fade-up-fast" data-bgset="images/pages/contact-bg.webp">
	<div class="container">
		<div class="row">
			<div class="col-12 col-md-9 col-xl-9">
				<div class="page-title-bg py-md-3">
					...
					<p>Have a great question, comment or concern? Simply fill out the form below and click Submit. We will respond to all inquiries within 48 business hours.Check out our <a href="faq.php">Frequently Asked Questions</a>.</p>
...
<div class="holder">
	<div class="container">
		<div class="row vert-margin">
			<div class="col-sm-9"><div class="title-wrap"><h2 class="h1-style">Get In Touch With Us</h2>
