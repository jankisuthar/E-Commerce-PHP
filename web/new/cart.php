...
<div class="page-content">
	...
	<div class="cart-table-prd">
		<div class="cart-table-prd-image">
			<a href="product.php" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/products/product-01-1.webp" alt=""></a>
		</div>
		<div class="cart-table-prd-content-wrap">
			<div class="cart-table-prd-info">
				...
				<h2 class="cart-table-prd-name"><a href="product.php">Leather Pegged Pants</a></h2>
			</div>
			...
			<div class="cart-table-prd-price-total">
				<span style="font-weight: bold;">INR</span>360.00
			</div>
		</div>
	...
	<div class="cart-table-prd">
		<div class="cart-table-prd-image">
			<a href="product.php" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/products/product-16-1.webp" alt=""></a>
		</div>
		<div class="cart-table-prd-content-wrap">
			<div class="cart-table-prd-info">
				<div class="cart-table-prd-price">
					<div class="price-new"><span style="font-weight: bold;">INR</span>220.00</div>
				</div>
				<h2 class="cart-table-prd-name"><a href="product.php">Cascade Casual Shirt</a></h2>
			</div>
			<div class="cart-table-prd-qty">
				<div class="qty qty-changer">
					<button class="decrease"></button>
	...
	<div class="cart-table-prd">
		<div class="cart-table-prd-image">
			<a href="product.php" class="prd-img"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/products/product-02-1.webp" alt=""></a>
		</div>
		<div class="cart-table-prd-content-wrap">
			<div class="cart-table-prd-info">
				<div class="cart-table-prd-price">
					<div class="price-new"><span style="font-weight: bold;">INR</span>75.00</div>
				</div>
				<h2 class="cart-table-prd-name"><a href="product.php">Oversize Cotton Dress</a></h2>
			</div>
			<div class="cart-table-prd-qty">
				<div class="qty qty-changer">
					<button class="decrease"></button>
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.php">Midi Dress</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Midi Dress", "path":"images/skins/fashion/products/product-06-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.php">Genuine Leather</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Genuine Leather", "path":"images/skins/fashion/products/product-21-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.php">Pureboost Shoes</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Pureboost Shoes", "path":"images/skins/fashion/products/product-26-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.php">Multiple Pocket</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Multiple Pocket", "path":"images/skins/fashion/products/product-30-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="row d-flex">
		...
		<div class="col-auto card-total-price text-right"><span style="font-weight: bold;">INR</span> 475.00</div>
	</div>
