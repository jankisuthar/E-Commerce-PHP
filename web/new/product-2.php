...
<ul class="mmenu mmenu-js">
	...
	<li><a href="index.php">Fashion (Default) Skin</a><span class="submenu-link-image"><img src="images/screen/screen01.webp" alt=""></span></li>
	<li><a href="index-sport.php">Sport Skin</a><span class="submenu-link-image"><img src="images/screen/screen-sport.webp" alt=""></span></li>
	<li><a href="index-books.php">Books Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="images/screen/screen-books.webp" alt=""></span></li>
	<li><a href="index-electronics.php">Electronics Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="images/screen/screen-electronics.webp" alt=""></span></li>
	<li><a href="index-viping.php">Vaping Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="images/screen/screen-vaping.webp" alt=""></span></li>
	<li><a href="index-pets.php">Pets Skin</a><span class="submenu-link-image"><img src="images/screen/screen-pets.webp" alt=""></span></li>
	<li><a href="index-lingeries.php">Lingeries Skin</a><span class="submenu-link-image"><img src="images/screen/screen-lingeries.webp" alt=""></span></li>
	<li><a href="index-games.php">Games Skin</a><span class="submenu-link-image"><img src="images/screen/screen-games.webp" alt=""></span></li>
	<li><a href="index-helloween.php">Halloween Skin</a><span class="submenu-link-image"><img src="images/screen/screen-halloween.webp" alt=""></span></li>
	<li><a href="index-medical.php">Medical Skin</a><span class="submenu-link-image"><img src="images/screen/screen-medical.webp" alt=""></span></li>
	<li><a href="index-food.php">Food Market Skin</a><span class="submenu-link-image"><img src="images/screen/screen-food.webp" alt=""></span></li>
	<li><a href="index-cosmetics.php">Cosmetics Skin</a><span class="submenu-link-image"><img src="images/screen/screen-cosmetics.webp" alt=""></span></li>
	<li><a href="index-fishing.php">Fishing Skin</a><span class="submenu-link-image"><img src="images/screen/screen-fishing.webp" alt=""></span></li>
</ul>
<ul class="submenu-list mt-0">
	<li><a href="#">Cups&Mugs Skin <span class="menu-label menu-label--color1">Coming Soon</span></a><span class="submenu-link-image"><img src="images/screen/screen-cups.webp" alt=""></span></li>
	<li><a href="#">Bikes Skin <span class="menu-label menu-label--color2">Coming Soon</span></a><span class="submenu-link-image"><img src="images/screen/screen-bikes.webp" alt=""></span></li>
	<li><a href="#">T-Shirts Skin <span class="menu-label">Coming Soon</span></a><span class="submenu-link-image"><img src="images/screen/screen-tshirts.webp" alt=""></span></li>
	<li><a href="index-02.php">Home page 2</a><span class="submenu-link-image"><img src="images/screen/screen02.webp" alt=""></span></li>
	<li><a href="index-03.php">Home page 3</a><span class="submenu-link-image"><img src="images/screen/screen03.webp" alt=""></span></li>
	<li><a href="index-04.php">Home page 4</a><span class="submenu-link-image"><img src="images/screen/screen04.webp" alt=""></span></li>
	<li><a href="index-05.php">Home page 5</a><span class="submenu-link-image"><img src="images/screen/screen05.webp" alt=""></span></li>
	<li><a href="index-06.php">Home page 6</a><span class="submenu-link-image"><img src="images/screen/screen06.webp" alt=""></span></li>
	<li><a href="index-07.php">Home page 7</a><span class="submenu-link-image"><img src="images/screen/screen07.webp" alt=""></span></li>
	<li><a href="index-08.php">Home page 8</a><span class="submenu-link-image"><img src="images/screen/screen08.webp" alt=""></span></li>
	<li><a href="index-09.php">Home page 9</a><span class="submenu-link-image"><img src="images/screen/screen09.webp" alt=""></span></li>
	<li><a href="index-10.php">Home page 10</a><span class="submenu-link-image"><img src="images/screen/screen10.webp" alt=""></span></li>
	<li><a href="index-rtl.php">Home page RTL</a><span class="submenu-link-image"><img src="images/screen/screen-rtl.webp" alt=""></span></li>
</ul>
		</div>
	</li>
	...
	<li><a href="product.php">Product page</a>
		<ul>
			<li><a href="product.php">Product page variant 1<span class="menu-label menu-label--color3">Popular</span></a></li>
			<li><a href="product-2.php">Product page variant 2</a></li>
			<li><a href="product-3.php">Product page variant 3</a></li>
			<li><a href="product-4.php">Product page variant 4</a></li>
			<li><a href="product-5.php">Product page variant 5</a></li>
			<li><a href="product-6.php">Product page variant 6</a></li>
			<li><a href="product-7.php">Product page variant 7</a></li>
		</ul>
	</li>
	<li><a href="category.php">Category page</a>
		<ul>
			<li><a href="category.php">Left sidebar filters</a></li>
			<li><a href="category-closed-filter.php">Closed filters</a></li>
			<li><a href="category-horizontal-filter.php">Horizontal filters</a></li>
			<li><a href="category-listview.php">Listing View</a></li>
			<li><a href="category-empty.php">Empty category</a></li>
		</ul>
	</li>
	<li><a href="cart.php">Cart & Checkout</a>
		<ul>
			<li><a href="cart.php">Cart Page</a></li>
			<li><a href="cart-empty.php">Empty cart</a></li>
			<li><a href="checkout.php">Checkout variant 1</a></li>
			<li><a href="checkout-2.php">Checkout variant 2</a></li>
			<li><a href="checkout-3.php">Checkout variant 3</a></li>
		</ul>
	</li>
	<li><a href="account-create.php">Account</a>
		<ul>
			<li><a href="account-create.php">Login</a></li>
			<li><a href="account-create.php">Create account</a></li>
			<li><a href="account-details.php">Account details</a></li>
			<li><a href="account-addresses.php">Account addresses</a></li>
			<li><a href="account-history.php">Order History</a></li>
			<li><a href="account-wishlist.php">Wishlist</a></li>
		</ul>
	</li>
	<li><a href="blog.php">Blog</a>
		<ul>
			<li><a href="blog.php">Right sidebar</a></li>
			<li><a href="blog-left-sidebar.php">Left sidebar</a></li>
			<li><a href="blog-without-sidebar.php">No sidebar</a></li>
			<li><a href="blog-sticky-sidebar.php">Sticky sidebar</a></li>
			<li><a href="blog-grid.php">Grid</a></li>
			...
			<div class="mmenu-submenu-inside">
				<div class="container">
					<div class="mmenu-left width-25">
						...
						<h3 class="submenu-title"><a href="category.php">Pre-Collection<br>Spring-Summer 2021</a></h3>
					</div>
					<div class="mmenu-cols column-4">
						<div class="mmenu-col">
							<h3 class="submenu-title"><a href="category.php">Collections</a></h3>
							<ul class="submenu-list">
								<li><a href="category.php">Martins d'Art 2020/21<span class="submenu-link-txt">Available in boutiques from June 2019</span></a></li>
								<li><a href="category.php">Spring-Summer 2021<span class="submenu-link-txt">Available in boutiques from March 2019</span></a></li>
								<li><a href="category.php">Spring-Summer 2021 Pre-Collection<span class="submenu-link-txt">In boutiques</span></a></li>
								<li><a href="category.php">Cruise 2020/21<span class="submenu-link-txt">In boutiques</span></a></li>
						...
						<div class="mmenu-col">
							...
							<ul class="submenu-list">
								...
								<li><a href="category.php">Dresses<span class="menu-label menu-label--color3">SALE</span></a></li>
						...
						<div class="mmenu-col">
							<h3 class="submenu-title"><a href="category.php">Brands</a></h3>
							<ul class="submenu-list">
								<li><a href="category.php">Jackets</a></li>
								<li><a href="category.php">Dresses</a></li>
								<li><a href="category.php">Blouses & Tops</a></li>
								<li><a href="category.php">Cardigans & Pullovers</a></li>
								<li><a href="category.php">Skirts<span class="menu-label menu-label--color1">SALE</span></a></li>
								<li><a href="category.php">Pants & Shorts</a></li>
								<li><a href="category.php">Outerwear</a></li>
							</ul>
						</div>
				...
				<ul class="nav nav-level-1">
					<li><a href="index.php">Layouts<span class="menu-label menu-label--color1">New</span><span class="arrow"><i class="icon-angle-right"></i></span></a>
						<ul class="nav-level-2">
							<li><a href="index.php">Fashion (Default) Skin</a></li>
							<li><a href="index-sport.php">Sport Skin</a></li>
							<li><a href="index-helloween.php">Halloween Skin</a></li>
							<li><a href="index-medical.php">Medical Skin</a></li>
							<li><a href="index-food.php">Food Market Skin</a></li>
							<li><a href="index-cosmetics.php">Cosmetics Skin</a></li>
							<li><a href="index-fishing.php">Fishing Skin</a></li>
							...
							<li><a href="index-02.php">Home page 2</a></li>
							<li><a href="index-03.php">Home page 3</a></li>
							<li><a href="index-04.php">Home page 4</a></li>
							<li><a href="index-05.php">Home page 5</a></li>
							<li><a href="index-06.php">Home page 6</a></li>
							<li><a href="index-07.php">Home page 7</a></li>
							<li><a href="index-08.php">Home page 8</a></li>
							<li><a href="index-09.php">Home page 9</a></li>
							<li><a href="index-10.php">Home page 10</a></li>
							<li><a href="index-rtl.php">Home page RTL</a></li>
						</ul>
					</li>
					<li><a href="#">Pages<span class="arrow"><i class="icon-angle-right"></i></span></a>
						<ul class="nav-level-2">
							<li><a href="product.php">Product page<span class="arrow"><i class="icon-angle-right"></i></span></a>
							...
							<li><a href="category.php">Category page<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Left sidebar filters</a></li>
									<li><a href="category-closed-filter.php">Closed filters</a></li>
									<li><a href="category-horizontal-filter.php">Horizontal filters</a></li>
							...
							<li><a href="cart.php">Cart & Checkout<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="cart.php">Cart Page</a></li>
									<li><a href="cart-empty.php">Empty cart</a></li>
									<li><a href="checkout.php">Checkout variant 1</a></li>
							...
							<li><a href="account-create.php">Account<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="account-create.php">Login</a></li>
									<li><a href="account-create.php">Create account</a></li>
									<li><a href="account-details.php">Account details</a></li>
							...
							<li><a href="blog.php">Blog<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="blog.php">Right sidebar</a></li>
									<li><a href="blog-left-sidebar.php">Left sidebar</a></li>
									<li><a href="blog-without-sidebar.php">No sidebar</a></li>
					...
					<li><a href="category.php">New Arrivals<span class="arrow"><i class="icon-angle-right"></i></span></a>
						<ul class="nav-level-2">
							<li><a href="category.php">Shoes<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Heels</a></li>
									<li><a href="category.php">Boots</a></li>
									<li><a href="category.php">Flats</a></li>
									<li><a href="category.php">Sneakers &amp; Athletic</a></li>
									<li><a href="category.php">Clogs &amp; Mules</a></li>
								</ul>
							</li>
							<li><a href="category.php">Tops<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Dresses</a></li>
									<li><a href="category.php">Shirts &amp; Tops</a></li>
									<li><a href="category.php">Coats &amp; Outerwear</a></li>
									<li><a href="category.php">Sweaters</a></li>
								</ul>
							</li>
							<li><a href="category.php">Shoes<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
							...
							<li><a href="category.php">Bottoms<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Jeans</a></li>
									<li><a href="category.php">Pants</a></li>
									<li><a href="category.php">slippers</a></li>
									<li><a href="category.php">suits</a></li>
									<li><a href="category.php">socks</a></li>
								</ul>
							</li>
							<li><a href="category.php">Accessories<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Sunglasses</a></li>
									<li><a href="category.php">Hats</a></li>
									<li><a href="category.php">Watches</a></li>
									<li><a href="category.php">Jewelry</a></li>
									<li><a href="category.php">Belts</a></li>
								</ul>
							</li>
							<li><a href="category.php">Bags<span class="arrow"><i class="icon-angle-right"></i></span></a>
								<ul class="nav-level-3">
									<li><a href="category.php">Handbags</a></li>
									<li><a href="category.php">Backpacks</a></li>
									<li><a href="category.php">Luggage</a></li>
	...
	<div class="dropdn-content-block">
		...
		<div class="minicart-drop-fixed js-hide-empty">
			...
			<div class="minicart-drop-actions">
				<a href="cart.php" class="btn btn--md btn--grey"><i class="icon-basket"></i><span>Cart Page</span></a>
				<a href="checkout.php" class="btn btn--md"><i class="icon-checkout"></i><span>Check out</span></a>
			</div>
...
<div class="prd-block_main-image">
	<div class="prd-block_main-image-holder" id="prdMainImage">
		<div class="product-main-carousel js-product-main-carousel" data-zoom-position="inner">
			<div data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-01.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-01.webp"/></span></div>
			<div data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-02.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-02.webp"/></span></div>
			...
			<div data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-03.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-03.webp"/></span></div>
			<div data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-04.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-04.webp"/></span></div>
			<div data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-05.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-05.webp"/></span></div>
			<div data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-06.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-06.webp"/></span></div>
			<div data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-07.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-07.webp"/></span></div>
			<div data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-08.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-08.webp"/></span></div>
			<div data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-09.webp" class="lazyload fade-up elzoom" alt="" data-zoom-image="images/skins/fashion/product-page/product-09.webp"/></span></div>
		</div>
	...
	<div class="prd-block_main-image-links">
		...
		<a href="images/products//product-01.webp" class="prd-block_zoom-link"><i class="icon-zoom-in"></i></a>
	</div>
</div>
<div class="product-previews-wrapper">
	<div class="product-previews-carousel js-product-previews-carousel">
		<a href="#" data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-01.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-02.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" class="prd-block_video-link video-slide">
			<span><span><i class="icon icon-play"></i><img src="images/skins/fashion/product-page/product-video.webp" alt=""/></span></span>
		</a>
		<a href="#" data-value="Beige"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-03.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-04.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-05.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Black"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-06.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-07.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-08.webp" class="lazyload fade-up" alt=""/></span></a>
		<a href="#" data-value="Red"><span class="prd-img"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/skins/fashion/product-page/product-09.webp" class="lazyload fade-up" alt=""/></span></a>
	</div>
</div>
				</div>
			</div>
	...
	<div class="prd-block_info-top prd-block_info_item order-0 order-md-2">
		<div class="prd-block_price prd-block_price--style2">
			<div class="prd-block_price--actual"><span style="font-weight: bold;">INR</span>180.00</div>
	...
	<div class="prd-block_info-box prd-block_info_item">
		<div class="two-column"><p>Availability:
			...
			<p>Collection: <span> <a href="collections.php" data-toggle="tooltip" data-placement="top" data-original-title="View all">Women</a></span></p>
	...
	<div class="order-0 order-md-100">
		<form method="post" action="#">
			<div class="prd-block_options">
				<div class="prd-color swatches">
					...
					<ul class="images-list js-size-list" data-select-id="SingleOptionSelector-0">
						<li class="active">
							<a href="#" data-value="Beige" data-toggle="tooltip" data-placement="top" data-original-title="Beige"><span class="image-container image-container--product"><img src="images/skins/fashion/product-page/product-01.webp" alt=""></span></a>
						<li>
						<li>
							<a href="#" data-value="Black" data-toggle="tooltip" data-placement="top" data-original-title="Black"><span class="image-container image-container--product"><img src="images/skins/fashion/product-page/product-04.webp" alt=""></span></a>
						<li>
						<li>
							<a href="#" data-value="Red" data-toggle="tooltip" data-placement="top" data-original-title="Red"><span class="image-container image-container--product"><img src="images/skins/fashion/product-page/product-07.webp" alt=""></span></a>
						</li>
					</ul>
				</div>
			...
			<div class="prd-block_actions prd-block_actions--wishlist">
				...
				<div class="btn-wrap">
					<button class="btn btn--add-to-cart js-trigger-addtocart js-prd-addtocart" data-product='{"name":  "Leather Pegged Pants ",  "url ": "product.php",  "path ": "images/skins/fashion/product-page/product-01.webp",  "aspect_ratio ": "0.78"}'>Add to cart</button>
				</div>
		...
		<div class="prd-img-area">
			...
			<div class="prd-circle-labels">
				...
				<div class="colorswatch-label colorswatch-label--variants js-prd-colorswatch">
					...
					<ul>
						<li data-image="images/skins/fashion/products/product-06-1.webp"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="images/colorswatch/color-grey.webp" alt=""></a></li>
						<li data-image="images/skins/fashion/products/product-06-color-2.webp"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="images/colorswatch/color-green.webp" alt=""></a></li>
						<li data-image="images/skins/fashion/products/product-06-color-3.webp"><a class="js-color-toggle" data-toggle="tooltip" data-placement="left" title="Color Name"><img src="images/colorswatch/color-black.webp" alt=""></a></li>
					</ul>
				</div>
			</div>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Midi Dress with Belt", "path":"images/skins/fashion/products/product-06-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Stand Collar Shirt", "path":"images/skins/fashion/products/product-17-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Genuine Leather Strap Watch", "path":"images/skins/fashion/products/product-21-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Pureboost Running Shoes", "path":"images/skins/fashion/products/product-26-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Multiple Pocket Waist Pack", "path":"images/skins/fashion/products/product-30-1.webp", "url":"product.php", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="col-lg col-xl last-mobile">
					<div class="footer-block">
						<div class="footer-logo">
							<a href="index.php"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/logo-footer.webp 1x, images/logo-footer2x.webp 2x" alt="Logo"></a>
						</div>
			...
			<div class="row">
				...
				<div class="col col-sm-5 col-lg-4 col-xl-5 sticky-addcart_info">
					...
					<div class="sticky-addcart_price">
						<span class="sticky-addcart_price--actual"><span style="font-weight: bold;">INR</span>180.00</span>
						<span class="sticky-addcart_price--old"><span style="font-weight: bold;">INR</span>210.00</span>
					</div>
				</div>
				...
				<div class="col popup-addedtocart_info">
					<div class="row">
						...
						<div class="col popup-addedtocart_text">
							...
							<span class="popup-addedtocart_message">Added to <a href="cart.php" class="underline">Cart</a></span>
							<span class="popup-addedtocart_error_message"></span>
						</div>
					</div>
				</div>
				<div class="col-auto popup-addedtocart_actions">
					<span>You can continue</span> <a href="#" class="btn btn--grey btn--sm js-open-drop" data-panel="#dropdnMinicart"><i class="icon-basket"></i><span>Check Cart</span></a> <span>or</span> <a href="checkout.php" class="btn btn--invert btn--sm"><i class="icon-envelope-1"></i><span>Check out</span></a>
				</div>
			</div>
		</div>
	</div>
...
<div class="footer-sticky">
	<div class="payment-notification-wrap js-pn" data-visible-time="3000" data-hidden-time="3000" data-delay="500"
		 ...
		 data-products='[{"productname":"Leather Pegged Pants", "productlink":"product.php","productimage":"images/skins/fashion/products/product-01-1.webp"},{"productname":"Black Fabric Backpack", "productlink":"product.php","productimage":"images/skins/fashion/products/product-28-1.webp"},{"productname":"Combined Chunky Sneakers", "productlink":"product.php","productimage":"images/skins/fashion/products/product-23-1.webp"}]'>
		<div class="payment-notification payment-notification--squared">
			<div class="payment-notification-inside">
				<div class="payment-notification-container">
					...
					<div class="payment-notification-content-wrapper">
						<div class="payment-notification-content">
							...
							<a href="product.php" class="payment-notification-name js-pn-name js-pn-link">Applewatch</a>
				...
				<div class="payment-notification-qw prd-hide-mobile js-prd-quickview" data-src="ajax/ajax-quickview.php"><i class="icon-eye"></i></div>
			</div>
		</div>
	</div>
</div>
