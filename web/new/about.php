...
<div class="page-content">
	<div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload" data-bgset="images/pages/about-bg.webp">
	<div class="container">
		<div class="row">
		...
		<div class="row person-row">
			<div class="person-item image-hover-scale-scale">
				<div class="person-item-image image-container" style="padding-bottom: 141.86%;">
					<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/pages/img-person-01.webp" alt="">
				</div>
			...
			<div class="person-item image-hover-scale-scale">
				<div class="person-item-image image-container" style="padding-bottom: 141.86%;">
					<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/pages/img-person-02.webp" alt="">
				</div>
				<div class="person-item-info">
					<div class="person-item-title">
						Chen<br>Khoo
			...
			<div class="person-item image-hover-scale-scale">
				<div class="person-item-image image-container" style="padding-bottom: 141.86%;">
					<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/pages/img-person-03.webp" alt="">
				</div>
				<div class="person-item-info">
					<div class="person-item-title">
						Marta<br>Stewart
			...
			<div class="person-item image-hover-scale-scale">
				<div class="person-item-image image-container" style="padding-bottom: 141.86%;">
					<img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/pages/img-person-04.webp" alt="">
				</div>
				<div class="person-item-info">
					<div class="person-item-title">
						Sandra<br>Adams
