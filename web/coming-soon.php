...
<head>
	...
	<title>Nirav Patel HTML Template - Nirav Patel eCommerce HTML Template</title>
...
<body>
	...
	<div class="container coming-soon-block">
		...
		<div class="countdown-box-footer">
	...
	<li>
		<a href="#"><i class="icon-google"></i></a>
			...
			<div class="countdown-box-footer-text">Stay tuned to stay up to date</div>
		</div>
	</div>
</div>
<div class="modal-info-content modal-info-content-sm" style="display: none;" id="countdownLogin">
	<div class="countdown-box-login-form">
		<form action="#">
			<div class="form-group">
				<input type="password" class="form-control" placeholder="Password">
			</div>
			<button type="submit" class="btn btn--lg w-100">Sign in</button>
		</form>
	</div>
</div>
	</div>
