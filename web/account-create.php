		...
		<div class="row justify-content-center">
			<div class="col-md-18 col-lg-12">
				...
				<div class="form-wrapper">
					<p>Already a member ? Please login here to continue. <span  ><a href="account-login" style="font-weight: bold;font-size:16px;" >Sign In</span></a></p>
					 
         


         <form id="myform"  enctype="multipart/form-data" method="post" onsubmit="return validateForm()">
						...
						<div class="row">
							<div class="col-sm-9">
								...
								<div class="form-group">
												<input type="text" class="form-control" name="cust_username" placeholder="Username">
											</div>
											<div class="form-group">
												<input type="text" class="form-control" name="cust_email" placeholder="E-mail">
											</div>
										...
										<div class="col-sm-9">
													<div class="form-group">
														<input type="text" class="form-control" name="cust_fname" placeholder="First name">
													</div>

													<div class="form-group">
														<input type="text" class="form-control" name="cust_lname" placeholder="Last name">
													</div>
											...
											<div class="form-group">
												<input type="password" class="form-control" id="password" name="cust_password" placeholder="Password">
											</div>
											<div class="form-group">
												<input type="password" class="form-control" name="cust_cpass" placeholder="Confirm Password">
											</div>
											...
											<div class="form-check-inline">
											  <label class="form-check-label">
											    <input type="checkbox" class="form-check-input" name="cust_language[]" value="Gujarati"> Gujarati
											  </label>
											</div>
											<div class="form-check-inline">
											  <label class="form-check-label">
											    <input type="checkbox" class="form-check-input" name="cust_language[]" value="Hindi"> Hindi
											  </label>
											</div>
											<div class="form-check-inline">
											  <label class="form-check-label">
											    <input type="checkbox" class="form-check-input" name="cust_language[]" value="English" > English
											  </label>
											</div>
											...
											<div class="form-group">  						
					 						 <textarea class="form-control" rows="5" id="comment" name="cust_address" placeholder="Address"></textarea>
											</div>
											<div class="form-group">
												<input type="text" class="form-control" name="cust_mobile" placeholder="Mobile Number">
											</div>
											<div class="form-group">
											...
											<div class="form-check-inline">
												...
												<label>By registering your details you agree to our <a href="#" >Terms and Conditions</a> and <a href="#" >Cookie Policy</a></label>
											</div>
											<div class="text-center">
												<input type="submit" name="register" value="create an account" class="btn">
											</div>
					</form>
...
$( "#myform" ).validate({
  rules: {
    ...
    cust_img:
     ...
     {
      required: true,
      extension: "jpg|JPG|png|PNG|jpeg|JPEG|gif|GIF|png|png"
    },
