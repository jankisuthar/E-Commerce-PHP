      ...
      <div class="container-fluid">
        ...
        <div class="row">
         ...
         <form id="myform" action="" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
            ...
            <h2 style="text-align: center;"><u>Add Subcategory</u></h2>
            <table class="table table-borderless">
             ...
             <tr>
              ...
              <tr>
                <td>Subcategory Name:
                <input type="text" name="subcate_name" id="subcate_name" class="form-control"></td>
              </tr>          
              ...
              <tr>
                ...
                <td><input type="submit" name="submit" class="btn btn-info btn-block" value="Add Subcategory"></td>
              </tr>
            </tbody>
            </table>
          </form>
